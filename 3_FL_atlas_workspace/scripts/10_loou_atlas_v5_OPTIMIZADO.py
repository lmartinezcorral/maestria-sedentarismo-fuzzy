...
def main():
    ...
    for test_user in usuarios:
        ...
        # Identificar cluster alto ID (usando misma lógica que clustering_train línea 188-190)
        cluster_means = df_train.groupby('cluster_label')[
            'Actividad_relativa_p50'].mean()
