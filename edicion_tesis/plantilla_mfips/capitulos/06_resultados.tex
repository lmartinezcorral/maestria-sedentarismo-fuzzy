...
% INSTRUCCIÓN: Crea tu gráfico de distribución y colócalo en figuras/distribucion_variable1.png
...
% INSTRUCCIÓN: Crea tu diagrama de tesis y colócalo en figuras/diagrama_tesis.png
% Luego descomenta las líneas de arriba
