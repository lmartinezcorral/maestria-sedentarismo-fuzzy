...
\begin{itemize}
    ...
    \item \textbf{OE3 - Diseño del sistema de inferencia difusa:} \textbf{Cumplido.} Se diseñó un sistema \textit{Mamdani} con 5 reglas lingüísticas fundamentadas fisiológicamente, con funciones de pertenencia triangulares calibradas a partir de los percentiles 25, 50 y 75 de cada variable observada en los datos. La estructura \textit{if-then} garantiza interpretabilidad clínica completa.
    ...
    \item \textbf{OE5 - Análisis de sensibilidad mediante ablación:} \textbf{Cumplido.} El análisis de ablación sistemático reveló que \textit{HRV-SDNN}, a pesar de su débil asociación univariada, es crítico para el desempeño multivariado (ablación: -51\% F1-Score), lo que caracteriza la contribución relativa de cada variable al modelo predictivo.
\end{itemize}
