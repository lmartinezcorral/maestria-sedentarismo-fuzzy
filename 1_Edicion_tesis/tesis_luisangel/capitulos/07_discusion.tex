...
\begin{enumerate}
    ...
    \item \textbf{Para tomadores de decisiones en salud pública:} Se recomienda la incorporación de modelos explicables basados en datos de wearables en programas nacionales de vigilancia epidemiológica del sedentarismo, lo cual permite monitoreo poblacional escalable sin requerir equipamiento de investigación costoso. El enfoque BYOD favorece la equidad al aprovechar infraestructura tecnológica personal existente.
