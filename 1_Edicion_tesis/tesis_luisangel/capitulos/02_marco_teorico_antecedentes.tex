...
% Generado por: Poseidón 🔱 (12 Nov 2025)
% 17 artículos representativos + investigación actual

La \Cref{tab:comparativa_investigaciones} presenta un análisis comparativo de las principales investigaciones relacionadas con la clasificación de comportamiento sedentario y actividad física mediante dispositivos wearables. El cuadro incluye estudios representativos que abarcan diversas técnicas metodológicas (lógica difusa, machine learning, deep learning, métodos estadísticos), tipos de validación (LOUO/LOSO destacados) y aplicaciones en contextos de vida libre.

% Tabla multi-página con longtable (APA permite continuación en segunda página)
\footnotesize
...
\multicolumn{8}{c}{\textit{(Continuación de Tabla \ref{tab:comparativa_investigaciones})}} \\
\toprule
\textbf{Autor (Año)} & 
\textbf{Objetivo} & 
\textbf{Técnica} & 
