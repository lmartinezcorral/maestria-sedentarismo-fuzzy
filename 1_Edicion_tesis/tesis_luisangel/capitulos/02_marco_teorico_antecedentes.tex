...
Los wearables modernos integran principalmente dos tipos de sensores para monitoreo de actividad y salud cardiovascular: \textbf{(1) Acelerómetros triaxiales}, que miden aceleración en tres ejes espaciales (m/s² o fuerza G), permitiendo cuantificar movimiento corporal, conteo de pasos y estimación de gasto energético, y \textbf{(2) Fotopletismografía óptica (PPG)}, técnica no invasiva basada en emisores LED y fotorreceptores que detectan variaciones en la absorción lumínica del flujo sanguíneo, permitiendo medir frecuencia cardíaca (FC), variabilidad cardíaca (HRV) y saturación de oxígeno (SpO$_2$) de manera continua \citep{Bent2020,Shcherbina2017,Henriksen2018,White2019}. La combinación de acelerometría (actividad mecánica) y PPG (respuesta cardiovascular) en dispositivos de consumo como el Apple Watch posibilita capturar tanto el comportamiento motor como la respuesta fisiológica en condiciones de vida libre, superando las limitaciones de cuestionarios de autoinforme.
