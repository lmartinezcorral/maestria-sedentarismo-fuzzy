...
Empleamos un diseño cuantitativo, observacional, longitudinal retrospectivo con seguimiento multianual (2021-2024) de una cohorte de 10 participantes adultos. El estudio se estructuró en tres fases metodológicas principales: (1) recolección y adquisición de datos mediante cuestionarios de autoinforme y dispositivos \textit{wearables} bajo el paradigma \textit{Bring Your Own Device} (\textit{BYOD}), (2) procesamiento, limpieza y agregación de datos biométricos longitudinales, y (3) diseño y validación de un sistema de inferencia difusa para clasificación del comportamiento sedentario. La unidad de análisis correspondió a semanas completas de monitoreo, generadas a partir de la agregación temporal de datos diarios recopilados de forma continua.
...
Del análisis de los 423 dispositivos de la base de datos \cite{Henriksen2021ReplicationData}, identificamos que todos cuentan con acelerómetro, esencial para medir la intensidad y frecuencia del movimiento. Sin embargo, solo el 38.3\% de los dispositivos (162 de 423) incluyen un sensor de fotopletismografía (PPG), crucial para medir frecuencia y variabilidad cardíaca, indicadores relevantes para evaluar esfuerzo físico y salud cardiovascular \cite{Pinto2023Physiology}. 

El análisis de mercado identificó a Apple como el líder en la categoría de relojes inteligentes, con un 49\% de la cuota global, seguido por Samsung (15\%) y Garmin (11\%) \cite{Canalys2024Wearables}. Esta predominancia y la uniformidad en sus dispositivos justifican la elección del Apple Watch como el dispositivo más adecuado, asegurando una mayor representatividad de datos y compatibilidad con herramientas de análisis avanzadas. La \Cref{tab:wearables_comparison_extended} resume la matriz de decisión empleada para sustentar esta selección, incorporando a los principales proveedores disponibles en México. La tabla muestra, para cada criterio de evaluación como la penetración en México, la validación de sensores, la capacidad de exportación de datos, la consistencia entre hardware y software y la disponibilidad de \textit{SDK} o documentación, el desempeño comparativo de los principales dispositivos \textit{wearables} del mercado, incluyendo Apple Watch, Fitbit, Garmin, Polar y Huawei. La tabla se interpreta asignando a cada proveedor un nivel cualitativo por criterio (Alta, Media, Media-baja, Baja, Parcial, Sí, Limitada), lo que permite identificar fortalezas y debilidades relativas y facilita elegir el dispositivo con mayor solidez técnica y disponibilidad para investigación en el contexto nacional.
