...
El sistema implementa cinco reglas de inferencia tipo \textit{Mamdani} (\Cref{tab:reglas_difusas}). La activación de cada regla se calcula mediante la \textbf{t-norm de Gödel} \citep{Ross2010}:
