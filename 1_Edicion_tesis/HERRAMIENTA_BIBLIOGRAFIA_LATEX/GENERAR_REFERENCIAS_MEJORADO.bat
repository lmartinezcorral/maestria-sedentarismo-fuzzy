@echo off
chcp 65001 >nul
title Herramienta de Bibliografía para LaTeX - UACH (Versión Mejorada)

echo.
echo ================================================================================
echo   HERRAMIENTA DE BIBLIOGRAFÍA PARA LATEX - VERSIÓN MEJORADA
...
echo 🚀 Iniciando procesamiento mejorado...
echo    (Usa IA + extracción local inteligente)
echo.
python generar_referencias_mejorado.py
